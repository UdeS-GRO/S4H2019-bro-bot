...
/**
* make the motor spin to a given speed. Negative = clockwise ***********V�RIFIER CE STATEMENT
...
/**
* By setting dontMoveForward to 1, this fonction forbid the motor to go anti-clockwise ************ � V�RIFIER
*
*
* @param Nothing
* @return Nothing.
...
/**
* By setting dontMoveBackward to 1, this fonction forbid the motor to go clockwise ************ � V�RIFIER
*
*
* @param Nothing
* @return Nothing.
