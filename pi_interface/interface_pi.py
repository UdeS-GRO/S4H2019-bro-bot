...
if __name__ == '__main__':
    ser_write = serial.Serial("/dev/myOpenCR", 57600)
    ser_read = serial.Serial("/dev/myOpenCR", 57600)
else:
...
FINGERS_MODE_LIST = [("Control with interface", "GUI"), ("Control with glove", "GLOVE"), ("Lock position", "LOCK"),
                     ("Torque off", "FREE")]
